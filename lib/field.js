...
function Field(property, label) {
  ...
  this.__validateErrorsAlways = false;
  this.ignoreErrors = function () {
    return !this.__required && !this.__validateErrorsAlways;
  };
...
Field.prototype.validateErrorsAlways = function () {
  this.__validateErrorsAlways = true;
